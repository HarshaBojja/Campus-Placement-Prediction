...
pick_read = open('svm_model.pkl','rb')
#load our trained model using pickle.load into some variable
#deserialisation
svm_model = pickle.load(pick_read)
pick_read.close()
...
def predict():
    if request.method == "POST" :
        ...
        if y_pred == 0:
            ...
            return render_template('show.html',res="you can get placement")
